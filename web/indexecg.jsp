        ...
        <nav class="navbar navbar-inverse navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">Cardiology Guide - Assessments</a>
            </div>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="share/carousel1.jpg" alt="First slide">
          <div class="container">
            <div class="carousel-caption carousel-caption1">
              <h1>Cardiology Curriculum</h1>
              <p>A curriculum for Cardiology training</p>
<!--               <p><a class="btn btn-lg btn-primary" href="#" role="button">Sign up today</a></p>
 -->            </div>
          </div>
        </div>
        <div class="item">
          <img class="second-slide" src="share/carousel2.jpg" alt="Second slide">
          <div class="container">
...
<!--               <p><a class="btn btn-lg btn-primary" href="#" role="button">Learn more</a></p>
 -->            </div>
        ...
        <div class="item">
          <img class="third-slide" src="share/carousel3.jpg" alt="Third slide">
          <div class="container">
    ...
    <div class="container marketing">
      ...
      <div class="row">
        ...
        <div class="col-sm-4 text-center">
          ...
          <h2>Practice ECG Interpretation</h2>
          <p>Using the largest and most dynamic ECG teaching bank that is reviewed by experts in electrocardiology</p>
        ...
        <div class="col-sm-4 text-center">
          ...
          <h2>Assess Skill</h2>
          <p>Custom practice exams allow assessment of ECG interpretation skill</p>
          <p><a class="btn btn-default btn-info" href="#" role="button">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-sm-4 text-center">
          <img class="img-circle" src="share/circle3.jpg" alt="Generic placeholder image" width="140" height="140">
          <h2>Enhance Teaching</h2>
          <p>Use our high resolution bank of ECGs to enhance classroom teaching</p>
          <p><a class="btn btn-default btn-info" href="#" role="button">View details &raquo;</a></p>

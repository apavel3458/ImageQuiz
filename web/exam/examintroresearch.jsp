...
<html lang="en">
  <head>
	...
	<link href="<c:url value="/study/register.css"/>" rel="stylesheet">
  ...
  <body class="register">
  	<div class="panel panel-primary centerPositionNonAbsolute">
  		<div class="panel-heading text-center">
    		<h2 class="panel-title regTitle">Welcome to the ECG Education Research Project</h2>
  		</div>
	    	...
	    	<form action="exam.do" id="myForm">
    			...
    			<input type="hidden" name="<%= Constants.TOKEN_KEY %>" value="<%= session.getAttribute(Globals.TRANSACTION_TOKEN_KEY) %>">
	    		    	    	<c:choose>
		    		    	    	...
		    		    	    	<c:when test="${sessionScope.researchPart2}">
										<div class="boxTitle">Welcome back!  This is a delayed post test with 11 questions.  Good luck!</div>
									</c:when>
									<c:when test="${!requestScope.resumeQuiz}">
										<div class="boxTitle">You are ready to start the module!</div>
										<div class="boxTitle">There will be 30 practice questions and 11 immediate post-test questions.</div>
									</c:when>
	    		    			</c:choose>
				        ...
				        <div class="form-group">
					      <div class="text-center">
					        <button type="button" name="quit" class="btn btn-danger quitButton" onclick="document.location='<c:url value="/study/registration.jsp"/>'">Quit</button>

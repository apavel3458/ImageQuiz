...
<form id="msform" action="exam.do">
	...
	<!-- progressbar -->
	<ul id="progressbar">
		<li style="width: 50%;">Test</li>
		<li style="width: 50%;" class="active">End</li>
	</ul>
	<!-- fieldsets -->
	
	<fieldset>
			<h2 class="fs-title finished">Thank you for reviewing the cases.</h2>
			<h2 class="fs-title finished">You may now close this window.</h2>
		...
		<input type="button" name="quit" class="action-button" onclick="document.location='${baseURL}/index.jsp'" value="Exit">
	</fieldset>
</form>

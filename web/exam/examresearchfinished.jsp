...
<form id="msform" action="exam.do">
	...
	<ul id="progressbar">
		...
		<li style="width: 33%;">End Module</li>
		<li style="width: 33%;" class="active">Delayed Post-Test</li>
	</ul>
	<!-- fieldsets -->
	
	<fieldset>
			<h2 class="fs-title finished">We thank you for your contribution to medical education research, and hope you improved your ECG interpretation skills! <br/> The module is now complete, have a great day!</h2>

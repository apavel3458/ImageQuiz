...
<form id="msform" action="exam.do">
	...
	<!-- progressbar -->
	<ul id="progressbar">
		<li style="width: 100%;" class="active">Start Practice</li>
	</ul>
	<!-- fieldsets -->
	
	<fieldset>
			<h2 class="fs-title finished">Welcome! <br> Click 'Start' to Begin</h2>
			...
			<table class="quizIntroTable" style="margin-left: auto; margin-right: auto;">
	        	<tr><th>
	        		...
	        		<td>
	        			<c:out value="${param.questionNumber }"/> questions
	        		</td>
	        	</tr>
        	</table>

		<input type="button" name="quit" class="action-button" onclick="document.location='<c:url value="/case/case.do?method=explore"/>'" value="Exit">
		<input type="button" name="start" class="action-button" onclick="document.location='<c:url value="/case/practice.do?ignoreRefreshToken=true"/>'" value="Start">
	</fieldset>
</form>

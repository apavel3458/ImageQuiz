...
<form id="msform" action="exam.do">
	...
	<!-- progressbar -->
	<ul id="progressbar">
		<li style="width: 33%;">Start Practice Set</li>
		<li style="width: 33%;">Practice!</li>
		<li style="width: 33%;" class="active">End Practice Set</li>
	</ul>
	<!-- fieldsets -->
	
	<fieldset>
			<h2 class="fs-title finished">Practice Set Finished!</h2>
		...
		<input type="button" name="quit" class="action-button" onclick="document.location='<c:url value="${sessionScope.userPracticeQuizExitUrl}"/>'" value="Exit">
	</fieldset>
</form>
